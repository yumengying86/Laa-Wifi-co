...
tcpInitialCw=10
# control LTE RLC mode (AM or UM) for TCP
tcpRlcMode=RlcAm
# if set to 1, drop packets upon failure to obtain channel access
dropPackets=1
# Set to value '0' for LAA SISO, '2' for LAA MIMO
laaTxMode=2
# uncomment this to get verbose TCP logging
# export NS_LOG="TcpL4Protocol:TcpNewReno"
