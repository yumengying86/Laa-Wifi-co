...
LbtTxopTestCase::DoRun (void)
{
  ...
  Ptr<LaaWifiCoexistenceHelper> lteWifiCoexistenceHelper = CreateObject<LaaWifiCoexistenceHelper> ();
  // configure LAA node
  //lteWifiCoexistenceHelper->ConfigureEnbDevicesForLbt(eNbDevice, phyParams);
  Simulator::Schedule (MilliSeconds(300), &LaaWifiCoexistenceHelper::ConfigureEnbDevicesForLbt, lteWifiCoexistenceHelper, eNbDevice, phyParams);
