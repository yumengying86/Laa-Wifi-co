...
./waf --run laa-wifi-simple --command="%s --cellConfigA=Wifi --cellConfigB=Wifi --d1=${d1} --d2=${d2} --simTag=${simTag} --transport=${transport} --udpRate=${udpRate} --logPhyArrivals=1 --logPhyNodeId=3 --duration=10 --outputDir=${outputDir}"
