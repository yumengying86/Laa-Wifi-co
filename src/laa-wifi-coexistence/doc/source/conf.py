...
master_doc = 'lbt-wifi-coexistence'

# General information about the project.
project = u'LBT WiFi Coexistence Project'
copyright = u'CTTC, UW'
...
version = 'ns-3-lbt rev. b48bfc33132b'
...
latex_documents = [
  ('lbt-wifi-coexistence', 'lbt-wifi-coexistence.tex', u'LTE LBT Wi-Fi Coexistence Module Documentation',
   u'ns-3 project', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = '../../../../doc/ns3_html_theme/static/ns-3.png'
