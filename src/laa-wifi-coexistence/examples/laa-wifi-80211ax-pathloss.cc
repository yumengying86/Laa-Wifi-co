...
int main (int argc, char** argv)
{
  ...
  outFile.open ("laa-wifi-80211ax-pathloss.gnuplot", std::ofstream::out | std::ofstream::trunc);

  GnuplotCollection gcRxPowerPdf ("laa-wifi-80211ax-rx-power.pdf");
  gcRxPowerPdf.AddPlot (rxPowerPlot);
  gcRxPowerPdf.GenerateOutput (outFile);

  GnuplotCollection gcRxPowerPng ("laa-wifi-80211ax-rx-power.png");
